...
def missing_checkout(data):
    """fixes data quuality issue: last cvustomers of the day
           are missing from checkout """
    ...
    for cust in diff:
        data = data.append({"timestamp": pd.to_datetime(new_time_stemp), "customer_no": cust,
